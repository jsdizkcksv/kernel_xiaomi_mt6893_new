...
LSM_HOOK(int, 0, file_open, struct file *file, const struct cred *cred)
...
LSM_HOOK(int, 0, msg_queue_alloc_security, struct msg_queue *msq)
LSM_HOOK(void, LSM_RET_VOID, msg_queue_free_security,
	 struct msg_queue *msq)
LSM_HOOK(int, 0, msg_queue_associate, struct msg_queue *msq, int msqflg)
LSM_HOOK(int, 0, msg_queue_msgctl, struct msg_queue *msq, int cmd)
LSM_HOOK(int, 0, msg_queue_msgsnd, struct msg_queue *msq,
	 struct msg_msg *msg, int msqflg)
LSM_HOOK(int, 0, msg_queue_msgrcv, struct msg_queue *msq,
	 struct msg_msg *msg, struct task_struct *target, long type, int mode)
LSM_HOOK(int, 0, shm_alloc_security, struct shmid_kernel *shp)
LSM_HOOK(void, LSM_RET_VOID, shm_free_security, struct shmid_kernel *shp)
LSM_HOOK(int, 0, shm_associate, struct shmid_kernel *shp, int shmflg)
LSM_HOOK(int, 0, shm_shmctl, struct shmid_kernel *shp, int cmd)
LSM_HOOK(int, 0, shm_shmat, struct shmid_kernel *shp, char __user *shmaddr,
	 int shmflg)
LSM_HOOK(int, 0, sem_alloc_security, struct sem_array *sma)
LSM_HOOK(void, LSM_RET_VOID, sem_free_security, struct sem_array *sma)
LSM_HOOK(int, 0, sem_associate, struct sem_array *sma, int semflg)
LSM_HOOK(int, 0, sem_semctl, struct sem_array *sma, int cmd)
LSM_HOOK(int, 0, sem_semop, struct sem_array *sma, struct sembuf *sops,
